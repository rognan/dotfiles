#!/usr/bin/env bash
#
# By and large a copy of: https://github.com/mathiasbynens/dotfiles/blob/main/.macos
...
# Set computer name
old_computer_name=`sudo scutil --get ComputerName`
read -p "Computer Name (${old_computer_name}): " computer_name
if [ -z ${computer_name} ]; then
    computer_name=${old_computer_name}
fi
sudo scutil --set ComputerName ${computer_name}
sudo scutil --set HostName ${computer_name}
sudo scutil --set LocalHostName ${computer_name}
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "${computer_name}"
unset old_computer_name
...
echo 'Configuration changed. Restart for all changes to take effect.'
